...
<html>
<head>
<title>Persyaratan | Izin Air PemKot Bandung</title>
<!-- Bootstrap -->
...
<body><div class="header_bg"><!-- start header -->
	<div class="container">
		  ...
		  <div class="container-fluid">
		    ...
		    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
		      <ul class="menu nav navbar-nav ">
		        ...
		        <li class="active"><a href="{{URL::to('pemohon/persyaratan')}}">persyaratan</a></li>
