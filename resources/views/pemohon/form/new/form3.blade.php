			...
			<div class="row contact">			
				<div class="col-md-10">
				  <div class="contact-form">
				  	<h2>Data Pemohon</h2>
					    <form class="form-horizontal" role="form" method="post" action="pemohon/form/new/3">
						    ...
						    <div class="form-group">
						      ...
						      <div class="col-sm-10">
						        <input type="file" class="form-control" id="teknis">rencana volume air yang akan dibuang
						      </div>
						    </div>
							...
							<div class="form-group">
						      <label class="control-label col-sm-2" for="bplh" style="font-size:14px">Rekomendasi dari BPLH</label>
						      <div class="col-sm-10">
						        <input type="file" class="form-control" id="bplh"> 
						      </div>
						    </div>
    					</div>
			    <div class="form-group">        
