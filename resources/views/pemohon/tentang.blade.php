...
<html>
<head>
<title>Tentang | Izin Air PemKot Bandung</title>
<!-- Bootstrap -->
		...
		<nav class="navbar" role="navigation">
		  <div class="container-fluid">
		    ...
		    <div class="navbar-header">
		      ...
		      <a class="navbar-brand" href="{{URL::to('izinair/pemohon')}}"><img src="{{URL::asset('images/pemkot.png')}}" style="witdh:75px; height:75px" alt="" class="img-responsive"/> </a>
		    </div>
		    ...
		    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
		      <ul class="menu nav navbar-nav ">
		        ...
		        <li class="active"><a href="{{URL::to('izinair/pemohon/tentang')}}">tentang</a></li>
		      </ul>
